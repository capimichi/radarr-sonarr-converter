...
class DefaultContainer:
    ...
    def _init_bindings(self):
        ...
        self.injector.binder.bind(RadarrBaseUrlVariable, RadarrBaseUrlVariable(self.radarr_base_url))
        self.injector.binder.bind(RadarrApiKeyVariable, RadarrApiKeyVariable(self.radarr_api_key))
